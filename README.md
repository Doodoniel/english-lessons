...
| 4 | [Champions](unit4-champions/) | SB p.24–25: sports vocabulary, `do / go / play`, квиз «Race against the clock» с таймером на 5 минут, reading «Meet the new BMXers» (5 пропущенных предложений). Начинается с игры **Adjective Championship** — 15 минут, 3 раунда, 20 самых частых прилагательных в comparative/superlative (короткие, длинные, неправильные + все ловушки написания). Домашка WB p.16–17. Аудио SB tracks 15–17 — папка готова. Письмо и рисование поверх страницы включены **только на вкладках домашки** |
...
| ★ | [Revision Checkpoint · Units 3–4](revision-units-3-4/) | Повторение Units 3–4, 14 этапов, без страниц учебника. Три мини-игры (word blitz на 60 секунд, odd one out, спелинг-лаб), сортировка `do / go / play` по колонкам, таймлайн жизненных событий, коллокации, MC и open cloze, proofreading, word order, оригинальный текст «The fastest way out of town» (пропущенные предложения + True/False/Doesn't say + слова в контексте), writing с автопроверкой форм, speaking по карточкам, отчёт по скиллам. **Спелинг-лаб**: 10 трудных слов — даётся значение, число букв и слогов и только первая буква; кнопка 💡 открывает следующую букву (и дальше по одной), каждая подсказка стоит четверть балла |
...
| 9 | [The Fourth Floor](lesson-9-fourth-floor/) | Отдельный курс A2 (продолжение урока 8), 60 мин, без страниц учебника: игра **Vocabulary Sprint** (12 значений за 60 секунд, счёт и серия), предтекстовая лексика и наречия на `-ly`, связки `because / so / but / although` (выбор, соединение предложений, редактура нелогичной связки), reading «The Flat on the Fourth Floor» (≈390 слов: gist → True/False/Doesn't say → чтение между строк → слова в контексте → развёрнутые ответы), speaking (объясни слово, монолог на 90 секунд, ролевая игра). Домашка из 7 механик: кнопка собирает все ответы в лист с автопроверкой и открывает печать → **Save as PDF**, есть и выгрузка в `.txt` |
